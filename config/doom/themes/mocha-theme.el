...
(def-doom-theme mocha
  ...
  ;; name        default   256       16
  ((bg         '("#1e1e2e" "#1e1e2e" "black"        ))
   (bg-alt     '("#1e1e2e" "#1e1e2e" "black"        ))
