...
(def-doom-theme hojicha
  ...
  ;; name        default   256       16
  ((bg         '("#161616" "#161616" "#161616"        ))
   (bg-alt     '("#161616" "#161616" "#161616"        ))
   (base0      '("#11111b" "#11111b" "#11111b"        ))
   (base1      '("#161616" "#161616" "#161616"  ))
   (base2      '("#1b1c1d" "#1b1c1d" "#1b1c1d"  ))
   (base3      '("#333333" "#333333" "#333333"  ))
   (base4      '("#585b70" "#585b70" "#585b70"  ))
   (base5      '("#6c7086" "#6c7086" "#6c7086"  ))
   (base6      '("#7f849c" "#7f849c" "#7f849c"  ))
   (base7      '("#ccccc7" "#cccccc" "#ccccc7"  ))
   (base8      '("#f8f8f2" "#dfdfdf" "#f8f8f2"        ))
   (fg         '("#adacac" "#adacac" "#adacac"        ))
   (fg-alt     '("#e2e2dc" "#bfbfbf" "#e2e2dc"  ))

   (grey       base4)
   (red        '("#9c797d" "#9e5560" "#9c797d"          ))
   (orange     '("#fab387" "#fab387" "#fab387"    ))
   (green      '("#8a968f" "#5c635f" "#8a968f"        ))
   (teal       '("#94e2d5" "#94e2d5" "#94e2d5"  ))
   (yellow     '("#b5ae84" "#b0b58a" "#b5ae84"       ))
   (blue       '("#808796" "#565a63" "#808796"   ))
   (dark-blue  '("#89b4fa" "#89b4fa" "#89b4fa"         ))
   (magenta    '("#a18b7f" "#695c55" "#a18b7f"      ))
   (violet     '("#8a879c" "#5c5a66" "#8a879c"))
   (cyan       '("#89dceb" "#89dceb" "#89dceb"   ))
   (dark-cyan  '("#8be9fd" "#88eeff" "#8be9fd"         ))
