...
;;
(def-doom-theme macchiato
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#24273a" "#24273a" "black"        ))
   (bg-alt     '("#24273a" "#24273a" "black"        ))
   (base0      '("#1e2030" "#1e2030" "black"        ))
   (base1      '("#24273a" "#24273a" "brightblack"  ))
   (base2      '("#363a4f" "#363a4f" "brightblack"  ))
   (base3      '("#494d64" "#494d64" "brightblack"  ))
   (base4      '("#5b6078" "#5b6078" "brightblack"  ))
   (base5      '("#6e738d" "#6e738d" "brightblack"  ))
   (base6      '("#8087a2" "#8087a2" "brightblack"  ))
   (base7      '("#ccccc7" "#cccccc" "brightblack"  ))
   (base8      '("#a5adcb" "#a5adcb" "white"        ))
   (fg         '("#cad3f5" "#cad3f5" "white"        ))
   (fg-alt     '("#b8c0e0" "#b8c0e0" "brightwhite"  ))

   (grey       base4)
   (red        '("#ed8796" "#ed8796" "red"          ))
   (orange     '("#f5a97f" "#f5a97f" "brightred"    ))
   (green      '("#a6da95" "#a6da95" "green"        ))
   (teal       '("#8bd5ca" "#8bd5ca" "brightgreen"  ))
   (yellow     '("#eed49f" "#eed49f" "yellow"       ))
   (blue       '("#91d7e3" "#91d7e3" "brightblue"   ))
   (dark-blue  '("#8aadf4" "#8aadf4" "blue"         ))
   (magenta    '("#f0c6c6" "#f0c6c6" "magenta"      ))
   (violet     '("#c6a0f6" "#c6a0f6" "brightmagenta"))
