...
;;
(def-doom-theme ashes
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#1c2023" "#1c2023" "black"        ))
   (bg-alt     '("#1c2023" "#1c2023" "black"        ))
   (base0      '("#11111b" "#11111b" "black"        ))
   (base1      '("#1c2023" "#1c2023" "brightblack"  ))
   (base2      '("#393f45" "#393f45" "brightblack"  ))
   (base3      '("#565E65" "#565E65" "brightblack"  ))
   ...
   (fg         '("#c7ccd1" "#c7ccd1" "white"        ))
   (fg-alt     '("#e2e2dc" "#bfbfbf" "brightwhite"  ))

   (grey       base4)
   (red        '("#c77c80" "#c77c80" "red"          ))
   (orange     '("#c7ae95" "#c7ae95" "brightred"    ))
   (green      '("#aec795" "#aec795" "green"        ))
   (teal       '("#95c7ae" "#95c7ae" "brightgreen"  ))
   (yellow     '("#c7c795" "#c7c795" "yellow"       ))
   (blue       '("#95aec7" "#95aec7" "brightblue"   ))
   (dark-blue  '("#95aec7" "#95aec7" "blue"         ))
   (magenta    '("#c795ae" "#c795ae" "magenta"      ))
   (violet     '("#ae95c7" "#ae95c7" "brightmagenta"))
   (cyan       '("#c79595" "#c79595" "brightcyan"   ))
