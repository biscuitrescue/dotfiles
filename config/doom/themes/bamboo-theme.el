...
;;
(def-doom-theme bamboo
  "A dark theme based on Dracula theme"
  ((bg         '("#252623" "#252623" "black"        ))
   (bg-alt     '("#1c1e1b" "#1c1e1b" "black"        ))
   (base0      '("#1c1e1b" "#1c1e1b" "black"        ))
   (base1      '("#252623" "#252623" "brightblack" ))
   (base2      '("#3a3d37" "#3a3d37" "brightblack" ))
   (base3      '("#5b5e5a" "#5b5e5a" "brightblack" ))
   (base4      '("#5b5e5a" "#5b5e5a" "brightblack" ))
   (base5      '("#f1e9d2" "#f1e9d2" "brightblack" ))
   (base6      '("#f1e9dc" "#f1e9dc" "brightblack" ))
   (base7      '("#fff8f0" "#fff8f0" "brightblack" ))
   (base8      '("#fff8f0" "#fff8f0" "white"        ))
   (fg         '("#f1e9d2" "#f1e9d2" "white"        ))
   (fg-alt     '("#f1e9dc" "#f1e9dc" "brightwhite" ))

   (grey       base4)
   (red        '("#e75a7c" "#e75a7c" "red"          ))
   (orange     '("#dbb651" "#dbb651" "brightred"   ))
   (green      '("#8fb573" "#8fb573" "green"       ))
   (teal       '("#70c2be" "#70c2be" "brightgreen" ))
   (yellow     '("#dbb651" "#dbb651" "yellow"      ))
   (blue       '("#57a5e5" "#57a5e5" "brightblue"  ))
   (dark-blue  '("#57a5e5" "#57a5e5" "blue"        ))
   (magenta    '("#aaaaff" "#aaaaff" "magenta"     ))
   (violet     '("#aaaaff" "#aaaaff" "brightmagenta"))
   (cyan       '("#70c2be" "#70c2be" "brightcyan"  ))
   (dark-cyan  '("#70c2be" "#70c2be" "cyan"        ))
   ...
   (selection      dark-blue)
   (builtin        dark-blue)
   (comments       (doom-darken base5 0.35))
  ...
  (((line-number &override) :foreground (doom-darken base5 0.35))
