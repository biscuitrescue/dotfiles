...
hl.bind("SUPER + SHIFT + D", hl.dsp.exec_cmd("dms ipc call spotlight-bar toggle"))
...
-- === Manual Sizing ===
hl.bind("SUPER + minus", hl.dsp.window.resize({ x = -5, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + equal", hl.dsp.window.resize({ x = 5, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + minus", hl.dsp.window.resize({ x = 0, y = -25, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + equal", hl.dsp.window.resize({ x = 0, y = 25, relative = true }), { repeating = true })
...
-- === Display Profiles ===
hl.bind("SUPER + CTRL + space", hl.dsp.exec_cmd("dms ipc outputs cycleProfile"))

-- === System Controls ===
hl.bind("SUPER + ALT + space", hl.dsp.dpms({ action = "toggle" }))

hl.bind("ALT+ SHIFT + P", hl.dsp.window.move({ workspace = "special:term" }))
hl.bind("ALT + P", hl.dsp.workspace.toggle_special("term"))
hl.bind("SUPER + SHIFT + P", hl.dsp.window.move({ workspace = "special:ed" }))
hl.bind("SUPER + P", hl.dsp.workspace.toggle_special("ed"))
