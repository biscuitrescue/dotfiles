...
;;
(def-doom-theme frappe
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#303446" "#303446" "black"        ))
   (bg-alt     '("#303446" "#303446" "black"        ))
   (base0      '("#292c3c" "#292c3c" "black"        ))
   (base1      '("#303446" "#303446" "brightblack"  ))
   (base2      '("#414559" "#414559" "brightblack"  ))
   (base3      '("#51576d" "#51576d" "brightblack"  ))
   (base4      '("#626880" "#626880" "brightblack"  ))
   (base5      '("#737994" "#737994" "brightblack"  ))
   (base6      '("#838ba7" "#838ba7" "brightblack"  ))
   (base7      '("#949cbb" "#949cbb" "brightblack"  ))
   (base8      '("#a5adce" "#a5adce" "white"        ))
   (fg         '("#c6d0f5" "#c6d0f5" "white"        ))
   (fg-alt     '("#b5bfe2" "#b5bfe2" "brightwhite"  ))

   (grey       base4)
   (red        '("#e78284" "#e78284" "red"          ))
   (orange     '("#ef9f76" "#ef9f76" "brightred"    ))
   ...
   (magenta    '("#eebebe" "#eebebe" "magenta"      ))
   (violet     '("#ca9ee6" "#ca9ee6" "brightmagenta"))
